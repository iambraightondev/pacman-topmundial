...
(function () {
  ...
  (function () {
    ...
    CFG.HAB.CATALOGO = {
      ...
      tanque: [
        ...
        [h('arrollar', 'R', 'APISONADORA', 46, 'Corre en línea recta hasta la pared.'),
         h('terremoto', 'R', 'TERREMOTO', 70, 'Manda a casa a todos los fantasmas.'),
      ...
      mago: [
        [h('fuego', 'Q', 'BOLA DE FUEGO', 20, 'Mata al primer fantasma.'),
         ...
         h('chispa', 'Q', 'CHISPA', 20, 'Aturde tres segundos, y salta.')],
    ...
    /* LA EXPLICACIÓN LARGA de cada poder (23 sep): la que sale en la ficha del
     * armario (ui.js). Sacada del código de cada uno, con sus números reales:
    ...
    CFG.HAB.DETALLE = {
      ...
      caceria: "6 S A X1,2 · LOS FANTASMAS DE LA CALLE QUEDAN MARCADOS: SOLO TÚ TE LOS PUEDES COMER, AUNQUE NO ESTÉN AZULES · TUS COMPAÑEROS NO",
      ...
      escudo: "8 S DE ESCUDO QUE AGUANTA UN GOLPE, TAMBIÉN DEL REY · AL ROMPERSE, EL FANTASMA SALE EMPUJADO 2 CASILLAS · SE SUMA A TU CORAZA: DOS GOLPES",
      yunque: "HASTA 2 S INTOCABLE MIENTRAS NO TE MUEVAS: EL FANTASMA QUE TE TOQUE REBOTA 1 CASILLA · AGUANTA TAMBIÉN AL REY · SI TE MUEVES SE ROMPE",
      piel_piedra: "5 S INMUNE: EL FANTASMA QUE TE TOQUE REBOTA 1 CASILLA Y EL REY NO TE MATA · A CAMBIO VAS A LA MITAD DE VELOCIDAD",
      provocar: "5 S: TODOS LOS FANTASMAS, AZULES INCLUIDOS, Y EL REY VAN A POR TI Y LOS QUE TE DABAN LA ESPALDA SE GIRAN · ATRAVIESAN A TU EQUIPO SIN MATARLO",
      grito_guerra: "APAGA 2,5 S A TODOS LOS FANTASMAS DE LA CALLE, ESTÉN DONDE ESTÉN: NI SE MUEVEN NI MATAN · AL REY LO PARA 0,8 S",
      arrollar: "EN LÍNEA RECTA HACIA TU ÚLTIMA FLECHA HASTA LA PARED, A X1,75 E INVULNERABLE · TE COMES A TODO FANTASMA QUE TOQUES (200) · AL REY: 4 DE VIDA Y 3 S PARADO",
      terremoto: "MANDA A CASA A TODOS LOS FANTASMAS DE LA CALLE, 100 PUNTOS CADA UNO, Y SACUDE EL MAPA · AL REY LE QUITA 6 DE VIDA",
      ...
      estela: "8 S CORRIENDO A X1,25 Y DEJANDO UN RASTRO · LOS COMPAÑEROS QUE LO PISAN VAN A X1,2 MIENTRAS DURE",
      puente: "ABRE UN PASO EN EL MURO QUE TIENES DELANTE (HASTA 4 CASILLAS DE GROSOR) DURANTE 8 S · LO CRUZA EL EQUIPO, LOS FANTASMAS NO",
      cadena: "TE ENLAZA 6 S AL COMPAÑERO MÁS CERCANO: LO QUE PUNTÚE CUALQUIERA DE LOS DOS VALE DOBLE · AGUANTA UN GOLPE A CUALQUIERA DE LOS DOS",
      aliado: "ESCUDO DE UN GOLPE (8 S) AL COMPAÑERO VIVO MÁS CERCANO · MANTÉN 2 S: ESCUDO A TODO EL EQUIPO, TÚ INCLUIDO, ESTÉN DONDE ESTÉN",
      muro: "PARED 10 S EN LA CASILLA DE DETRÁS DE TI: LOS FANTASMAS NO PASAN Y LOS QUE LLEGAN SALEN EMPUJADOS · EL EQUIPO LA ATRAVIESA",
